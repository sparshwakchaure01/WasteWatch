...
export const INITIAL_USERS: User[] = [
  {
    ...
    email: 'reporter@wastewatch.gov.in',
    phone: '+919823012345',
    role: 'Reporter',
    status: 'Active',
  ...
  },
  {
    ...
    email: 'anushree@wastewatch.gov.in',
    phone: '+919823054321',
    role: 'Reporter',
    status: 'Active',
  ...
  },
  {
    ...
    email: 'localbody@wastewatch.gov.in',
    phone: '+919890011223',
    role: 'Local Body',
    status: 'Active',
...
export const INITIAL_COMPLAINTS: Complaint[] = [
  {
    ...
    reporterEmail: 'reporter@wastewatch.gov.in',
  ...
  },
  {
    ...
    reporterEmail: 'anushree@wastewatch.gov.in',
